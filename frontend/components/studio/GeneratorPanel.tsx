...
import { SelectImage, ReadImageBase64, RenderShot, SetProjectThumbnail } from "../../wailsjs/go/main/App";

interface GeneratorPanelProps {
    activeShot: any;
    updateActiveShot: (updates: any) => void;
    project: any;
    scene: any;
    isRendering: boolean;
    setIsRendering: (val: boolean) => void;
    setVideoCache: (id: string, b64: string) => void;
